...
const SkillPage = () => {
    ...
    const cardData = React.useMemo(() => [
        { title: "JavaScript", subtitle: "3+ tahun pengalaman membangun web interaktif dan dinamis dengan ES6+." },
        { title: "TypeScript", subtitle: "Meningkatkan skalabilitas dan maintainability proyek besar dengan strong typing." },
        { title: "React", subtitle: "Menguasai SPA, hooks, state management, dan integrasi API dengan komponen modular." },
        { title: "Next.js", subtitle: "Ahli dalam SSR, SSG, dan optimasi performa untuk web modern yang super cepat." },
        { title: "Tailwind CSS", subtitle: "Mempercepat development UI secara signifikan dengan utility-first workflow." },
        { title: "Node.js", subtitle: "Membangun backend service yang cepat dan efisien menggunakan Express.js." },
        { title: "Laravel", subtitle: "Pengalaman dengan ekosistem PHP yang powerful untuk aplikasi backend yang solid." },
        { title: "Git", subtitle: "Manajemen version control yang efisien untuk kolaborasi tim menggunakan Git Flow." },
        { title: "Figma", subtitle: "Mampu menerjemahkan desain UI/UX kompleks menjadi kode yang pixel-perfect." },
    ], []);
